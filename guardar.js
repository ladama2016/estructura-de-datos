...
add1.addEventListener("click",function(o)
{
    o.preventDefault();
...
add2.addEventListener("click",function(a)
{
    a.preventDefault();
...
function add_1() 
{
    ...
    for(let i=10; i>=0; i--)
    {
        var divOriginal = document.getElementById(""+i);
        var divClonado = divOriginal.cloneNode(true);
        lugar=document.getElementById("10");
        divOriginal.parentNode.insertBefore(divClonado, lugar.nextSibling);
    }
